...
nextval('SQ_AC_FEE_SCDL'),(SELECT ID from AC_RSCY_CODE where code ='M' ),(SELECT ID FROM AC_CHRT_CODE WHERE CODE = 'FPV-PHD-0001-CHRT-201720181' ),(SELECT ID FROM AC_STDY_MODE WHERE CODE = '1' ),'YB-FPV-PHD-0001-CHRT-201720181','UDA YURAN PENGAJIAN PROGRAM SARJANA SAINS - VETERINAR (MOD PENYELIDIKAN)',0.00,1,CURRENT_TIMESTAMP,1); 
