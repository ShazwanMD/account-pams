INSERT INTO AC_PRGM_CODE (ID, FACULTY_CODE_ID, CODE, DESCRIPTION, C_TS, C_ID, M_ST,PROGRAM_LEVEL_ID)    VALUES (nextval('SQ_AC_PRGM_CODE'),    (SELECT ID
    FROM AC_FCTY_CODE FC
    WHERE FC.CODE = 'FIAT'),
   'FIAT-PHD-0001',
   'Doctor of Philosophy Bio-Industrial Technology',
    CURRENT_TIMESTAMP, 0, 1,(SELECT ID FROM AC_PRGM_LEVEL L WHERE L.CODE='PHD'));
INSERT INTO AC_PRGM_CODE (ID, FACULTY_CODE_ID, CODE, DESCRIPTION, C_TS, C_ID, M_ST,PROGRAM_LEVEL_ID)    VALUES (nextval('SQ_AC_PRGM_CODE'),    (SELECT ID
    FROM AC_FCTY_CODE FC
    WHERE FC.CODE = 'FIAT'),
   'FIAT-PHD-0002',
...
INSERT INTO AC_PRGM_CODE (ID, FACULTY_CODE_ID, CODE, DESCRIPTION, C_TS, C_ID, M_ST,PROGRAM_LEVEL_ID)    VALUES (nextval('SQ_AC_PRGM_CODE'),    (SELECT ID
   ...
   'Master of Science Bio-Industrial Technology',
    CURRENT_TIMESTAMP, 0, 1,(SELECT ID FROM AC_PRGM_LEVEL L WHERE L.CODE='MASTER'));
INSERT INTO AC_PRGM_CODE (ID, FACULTY_CODE_ID, CODE, DESCRIPTION, C_TS, C_ID, M_ST,PROGRAM_LEVEL_ID)    VALUES (nextval('SQ_AC_PRGM_CODE'),    (SELECT ID
    FROM AC_FCTY_CODE FC
    WHERE FC.CODE = 'FIAT'),
   'FIAT-MASTER-0002',
