INSERT INTO AC_FEE_SCDL (ID, DESCRIPTION ) VALUES (nextval('SQ_AC_FEE_SCDL'),'XXX'); 
...
INSERT INTO AC_FEE_SCDL_ITEM (ID, SCHEDULE_ID, AMOUNT ) VALUES (nextval('SQ_AC_FEE_SCDL_ITEM'),'JUMLAH KESELURUHAN (MINIMUM)',''); 
INSERT INTO AC_FEE_SCDL_ITEM (ID, SCHEDULE_ID, AMOUNT ) VALUES (nextval('SQ_AC_FEE_SCDL_ITEM'),'JUMLAH KESELURUHAN (MAKSIMUM)',''); 
