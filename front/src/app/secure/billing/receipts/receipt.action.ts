...
export class ReceiptActions {
    ...
    static REMOVE_RECEIPT_TASK = '[Receipt] Remove Receipt Task';
    removeReceiptTask( receiptTask ): Action {
        return {
            type: ReceiptActions.REMOVE_RECEIPT_TASK,
            payload: receiptTask,
        };
    }

    static REMOVE_RECEIPT_TASK_SUCCESS = '[Receipt] Remove Receipt Task Success';
    removeReceiptTaskSuccess( task ): Action {
        return {
            type: ReceiptActions.REMOVE_RECEIPT_TASK_SUCCESS,
            payload: task,
        };
    }
