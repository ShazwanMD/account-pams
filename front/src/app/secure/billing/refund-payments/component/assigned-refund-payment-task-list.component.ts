...
export class AssignedRefundPaymentTaskListComponent implements OnChanges {
  ...
  ngOnChanges(changes: {[ propName: string]: SimpleChange}) {
    if (changes['refundPaymentTasks']){
        this.filteredData = changes['refundPaymentTasks'].currentValue; 
        this.filteredTotal = changes['refundPaymentTasks'].currentValue.length;
        this.filter();
      }
    }
  ...
  filter(): void {
    let newData: any[] = this.refundPaymentTasks;
