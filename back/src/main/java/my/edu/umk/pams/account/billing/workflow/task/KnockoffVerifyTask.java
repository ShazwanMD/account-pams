...
@Component("knockoff_verify_ST")
public class KnockoffVerifyTask extends BpmnActivityBehavior implements ActivityBehavior {
    ...
    public void execute(ActivityExecution execution) throws Exception {
        ...
        knockoff.getFlowdata().setState(AcFlowState.VERIFIED);
