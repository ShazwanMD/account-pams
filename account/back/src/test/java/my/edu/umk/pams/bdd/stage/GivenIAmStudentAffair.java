...
@JGivenStage
public class GivenIAmStudentAffair {
	@Autowired
    ...
    public void I_am_student_affair(){
    	loginAsStudentAffair();
        academicSession = accountService.findCurrentAcademicSession();
    }

    private void loginAsStudentAffair() {
        UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken("studentaffair", "abc123");
